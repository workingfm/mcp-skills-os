...
Run: `cd /Users/[REDACTED]/python-projects/skill-os-docker && python -m pytest tests/test_fitness_tracker.py -v`
...
Run: `cd /Users/[REDACTED]/python-projects/skill-os-docker && python server/main.py 2>&1 | head -5`
